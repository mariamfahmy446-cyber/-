...
export const ToyBrickIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="3" y="8" width="8" height="8" rx="1"></rect><path d="M7 8v.01"></path><rect x="13" y="14" width="8" height="8" rx="1"></rect><path d="M17 14v.01"></path><path d="M4.6 11.4 8.4 15a2 2 0 0 1-1.4 3.4H6a2 2 0 0 1-2-2V13a2 2 0 0 1 .6-1.6Z"></path><path d="m13.4 4.6 3.8 3.8a2 2 0 0 1-1.4 3.4H14a2 2 0 0 1-2-2V7a2 2 0 0 1 .6-1.6Z"></path></svg>
);
...
export const ScarfIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M2.2 12.2c.2.2.5.4.8.6.8.5 2.2.8 3.8.3 1.6-.5 2.8-2 3.2-3.8.4-2.1-.2-4.1-1.4-5.6C7.2 2.2 5.2 1.6 3.6 2.1c-1.8.6-3 2.3-3.1 4.2-.1 1.3.4 2.6 1.2 3.6l.5.5Z"/>
        <path d="M11 22s-2.5-2.5-3-5c-.5-2.5.5-5 3-5s3.5 2.5 3 5c-.5 2.5-3 5-3 5Z"/>
        <path d="M13.4 2.6c1.5-1.5 3.9-.4 3.9 1.7s-1.1 4-2.6 5.5c-1.5 1.5-4 2.6-5.5 2.6S5.3 11 3.8 9.5s-2.6-4-2.6-5.5.9-3.2 2.4-1.7"/>
    </svg>
);
...
export const MailIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="2" y="4" width="20" height="16" rx="2"></rect><polyline points="22,6 12,13 2,6"></polyline></svg>
);
...
export const IdIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9.5" r="1.5"/><path d="M12 15h6"/><path d="M12 12h6"/></svg>
);
...
export const TheaterMasksIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M8.38 19.33a4.01 4.01 0 0 1-3.4-4.9 4.01 4.01 0 0 1 4.9-3.4 4.01 4.01 0 0 1 3.4 4.9 4.01 4.01 0 0 1-4.9 3.4Z"/>
        <path d="M11.5 12.5c0 .67.22 1.34.64 1.86"/>
        <path d="M8.5 15.5c0-.67-.22-1.34-.64-1.86"/>
        <path d="M15.62 19.33a4.01 4.01 0 0 1-3.4-4.9 4.01 4.01 0 0 1 4.9-3.4 4.01 4.01 0 0 1 3.4 4.9 4.01 4.01 0 0 1-4.9 3.4Z"/>
        <path d="M12.5 12.5c0 .67.22 1.34.64 1.86"/>
        <path d="M15.5 15.5c0-.67-.22-1.34-.64-1.86"/>
        <path d="M6 17.8c.6-.5 1.3-1 2.2-1 .9 0 1.5.3 2.1.8"/>
        <path d="M13.8 17.8c.6-.5 1.3-1 2.2-1 .9 0 1.5.3 2.1.8"/>
        <path d="M8.07 4.98A7.5 7.5 0 0 1 18.2 8.79"/>
        <path d="m10.15 5.3-2.52 2.52"/>
        <path d="M6.03 8.19A7.5 7.5 0 0 1 15.93 4.8"/>
        <path d="m12.35 5.5-2.52 2.52"/>
    </svg>
);
...
export const PaletteIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.668 0-.437-.18-.835-.47-1.125-.29-.29-.688-.47-1.125-.47H11c-.926 0-1.648-.746-1.648-1.668 0-.437.18-.835.47-1.125.29-.29.688-.47 1.125-.47H12c.926 0 1.648-.746 1.648-1.668 0-.437.18-.835.47-1.125.29-.29.688-.47 1.125-.47H14c.926 0 1.648-.746 1.648-1.668 0-.922.722-1.668 1.648-1.668.926 0 1.648.746 1.648 1.668 0 .437-.18.835-.47 1.125-.29-.29-.688-.47-1.125-.47H18c-.926 0-1.648-.746-1.648-1.668 0-.922.722-1.668 1.648-1.668.528 0 1.023.21 1.387.573C21.408 3.023 22 4.197 22 5.5c0 3.86-2.64 7-6 7-2.92 0-5.38-2.38-5.38-5.38S9.08 2 12 2z"/>
    </svg>
);
...
export const RoseIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M12 5a3 3 0 1 1 6 0 3 3 0 0 1-6 0z"/>
      <path d="M12 19a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
      <path d="M12 19a3 3 0 1 1 6 0 3 3 0 0 1-6 0z"/>
      <path d="M19 12a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
      <path d="M19 12a3 3 0 1 1 0 6 3 3 0 0 1 0-6z"/>
      <path d="M5 12a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
      <path d="M5 12a3 3 0 1 1 0 6 3 3 0 0 1 0-6z"/>
...
export const NotificationIconComponent: React.FC<{ icon: NotificationIcon; className?: string }> = ({ icon, className }) => {
    switch (icon) {
        case 'login':
        ...
        default:
            return <BellIcon className={className} />; // Fallback icon
    }
};